...
if (member.user.bot === true) {
    ...
    bot = ":x::robot: No";
            ...
            let embed = new Discord.RichEmbed()
                ...
                .setFooter(`${member.user.username}, do NOT tag Staff members, you will get notified soon.`, 'https://cdn3.iconfinder.com/data/icons/gradient-circle/36/5029-512.png');
